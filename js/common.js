...
var moblie_menu_cn =     '<div class="l-header">'+
                            '<div class="l-header_inner clearfix">'+
                              '<div class="m-logo">'+
                                '<a href="javascript:void(0);">'+
                                  '<img src="img/logo.png" height="65" width="255">'+
                                '</a>'+
                              '</div>'+
                              ...
                              '<nav id="l-gnavi-SP">'+
                              '<ul class="menu">'+
                                '<li class="m-gnavi nav_index">'+'<a href="CN_index.html">首页'+'</a>'+
                                  // '<div class="down_slide"><div class="down_slide_icon"></div></div>' +
                                  // '<ul class="gnav_sub">'+
                                  //   '<li>'+'<a href="">首页'+'</a>'+'</li>'+  
                                  // '</ul>'+
                                '</li>'+
                                '<li class="m-gnavi">'+'<a href="javascript:void(0);">关于我们'+'</a>'+
                                  '<div class="down_slide"><div class="down_slide_icon"></div></div>' +
                                  '<ul class="gnav_sub">'+
                                    '<li>'+'<a href="CN_about_company.html">关于公司'+'</a>'+'</li>'+  
                                    '<li>'+'<a href="CN_about_leader.html">关于管理'+'</a>'+'</li>'+
                                  '</ul>'+
                                '</li>'+
                                '<li class="m-gnavi">'+'<a href="CN_content.html">公司内容'+'</a>'+
                                '</li>'+
                                '<li class="m-gnavi">'+'<a href="CN_product.html">公司产品'+'</a>'+
                                '</li>'+
                                '<li class="m-gnavi">'+'<a href="CN_cooperation.html">合作案例'+'</a>'+ 
                                '</li>'+
                                '<li class="m-gnavi">'+'<a href="CN_contact.html">联系方式'+'</a>'+
                                '</li>'+
                                '<li class="m-gnavi">'+'<a href="CN_join.html">欢迎加入'+'</a>'+
                                '</li>'+
                              '</ul>'+
                              '<div id="sp_cse">'+'</div>'+
                            '</nav>'+
    ...
    $("#moblie_menu_cn").html(moblie_menu_cn);
     ...
     ********************/
    (function() {
      // $('#l-gnavi-SP .m-gnavi>a:not(.linkon)').on('click', function(event) {
      //     event.preventDefault();
      //     $(this).parent('li').toggleClass('on');
      //     return false;
      // });
      $('#l-gnavi-SP .m-gnavi .down_slide').on('click', function(event) {
          event.preventDefault();
          $(this).parent('li').toggleClass('on');
          return false;
      });
      $('#sp_btn').on('click', function(event) {
          event.preventDefault();
          $(this).toggleClass('open');
          $('#l-gnavi-SP').toggleClass('open');
          $('#l-gnavi-SP .m-gnavi').removeClass('on');

          if($('.l-contents').css("position")!= "absolute") {
              $('.l-contents').css("position", "absolute");
              $('footer').css("display", "none");
          }else{
              $('.l-contents').css("position", "relative");
